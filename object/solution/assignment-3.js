...
console.log('--- 3. Print out "store" to the terminal ---')
console.log(store);

console.log('--- 4. Only print out all the product objects in "store" ---')
console.log(store.products);

console.log('--- 5. Only print out the 3rd product object in "store" ---')
console.log(store.products[store.products.length - 1]);
//console.log(store.products.at(-1))

console.log('--- 6. Change the price of the banana object through the store object to be 1.75.. ---')
store.products[0].price = 1.75;

/* for(let i = 0; i < store.products.length; i++) {
    if(store.products[i].name === "banana") {
        store.products[i].price = 1.75;
    }
} */

console.log('--- 7. Print out both "store" and "banana" ---')
console.log(store);
console.log(banana);

console.log('--- 8. Change the price of the candy object directly to be 4.99 ---')
candy.price = 4.99;

console.log('--- 9. Print out both "store" and "candy" ---')
console.log(store);
console.log(candy);